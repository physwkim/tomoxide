...
//!
//! Currently implements `sino_360_to_180` — folding a 0–360° sinogram into a
//! 0–180° sinogram by stitching the second half-rotation (column-reversed) onto
//! the first, with a linear cross-fade across an `overlap`-wide seam.
